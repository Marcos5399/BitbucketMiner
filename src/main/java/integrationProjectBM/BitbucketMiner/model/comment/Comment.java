...
package integrationProjectBM.BitbucketMiner.model.comment;
...
public class Comment {
    ...
    private Integer id;
    @JsonProperty("created_on") // Corresponde a created_at GitMiner
    private String createdOn;
    @JsonProperty("updated_on") // Corresponde a updated_at GitMiner
